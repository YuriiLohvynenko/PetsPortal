...
ActiveRecord::Schema.define(version: 2023_10_12_134804) do
  ...
  create_table "pets", force: :cascade do |t|
    ...
    t.boolean "profile_display"
    t.index ["category_id"], name: "index_pets_on_category_id"
    t.index ["subcategory_id"], name: "index_pets_on_subcategory_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "prefecture"
    t.string "city"
    t.boolean "additional_info_completed"
    t.boolean "own_pet"
  ...
  add_foreign_key "pets", "subcategories"
