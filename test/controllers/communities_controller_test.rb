...
class CommunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post communities_url, params: { community: { category: @community.category, description: @community.description, title: @community.title } }
    end
  ...
  test "should update community" do
    patch community_url(@community), params: { community: { category: @community.category, description: @community.description, title: @community.title } }
